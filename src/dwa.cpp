...
Speed dwa_control(const Status& g_roomba, const std::vector<float>& l_ob, const Position& g_goal, const nav_msgs::Path& g_path)
{
  ...
  for(double v = dw.min_v; v <= dw.max_v; v += dv){
    for(double y = dw.min_omega; y <= dw.max_omega; y += dyaw){
      if((-exception_omega < y && y < 0.0) || (0.0 < y && y < exception_omega)) continue;
      std::cout << "-------------------------------------------------------------------------------------------" << std::endl;
      ...
      std::cout << "to_gpath_cost = " << to_g_gath_cost << std::endl;
      ...
      std::cout << "now min_cost =" << min_cost << std::endl;
      std::cout << "now min_ob_cost =" << min_ob_cost << std::endl;
      std::cout << "now min_speed_cost =" << min_speed_cost << std::endl;
      std::cout << "now min_to_goal_cost = " << min_to_goal_cost << std::endl;
      std::cout << "now min_to_gpath_cost = " << min_to_gpath_cost << std::endl;
      std::cout << "---------------------------------------------------------------------" << std::endl;
